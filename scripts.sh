gulp docker:stop --host 172.24.40.25 --username root --password tHYGN27A9cQM --service redis-manager-db-seed

gulp publish:dockerfile --host 172.24.40.25 --username root --password tHYGN27A9cQM --service redis-manager-db-seed

gulp docker:build --host 172.24.40.25 --username root --password tHYGN27A9cQM --service redis-manager-db-seed
